...
export default function Main() {
    ...
    function sceneInit() {
        ...
        setInterval(() => {
            ...
            // count % 2 ?
            // createBox({ width: 0.5, height: 0.5, depth: 0.5 }, { x: 1, y: 10 }) : createBox({ width: 0.5, height: 0.5, depth: 0.5 }, { x: -3, y: 10 })
            createBox({ width: 0.5, height: 0.5, depth: 0.5 }, { x: 1, y: 31 })
        }, 1500)

        // setInterval(() => {
        //     createBox({ width: 0.5, height: 0.5, depth: 0.5 }, { x: -3, y: 10 })
        ...
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 10 }, true)

        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 11 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 12 }, true)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 13 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 14 }, true)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 15 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 16 }, true)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 17 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 18 }, true)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 19 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 20 }, true)

        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 21 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 22 }, true)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 23 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 24 }, true)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 25 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 26 }, true)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 27 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 28 }, true)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: 1, y: 29 }, false)
        createMovingPlatform({ width: 3, height: 0.2, depth: 1 }, { x: -1, y: 30 }, true)
